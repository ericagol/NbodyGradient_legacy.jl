...
include("../test/test_hierarchy/setup_hierarchy.jl")
include("../test/test_hierarchy/amat.jl")
...
# Generates A matrix and calculates the rkepler and rdotkepler
amat_kep(amat,elements,IC,rkepler,rdotkepler)
